<h2><a href="https://leetcode.com/problems/smallest-unique-subarray">3934. Smallest Unique Subarray</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code>.</p>

<p>Find the <strong>minimum </strong>length of a <strong>subarray</strong> that is <strong>not</strong> <strong>identical</strong> to any other <strong>subarray</strong> in <code>nums</code>.</p>
